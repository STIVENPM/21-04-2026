...
CREATE TABLE aeronaves.aircraft_manufacturer (
...
CREATE TABLE aeronaves.aircraft_model (
    aircraft_model_id uuid PRIMARY KEY DEFAULT gen_random_uuid(),
    aircraft_manufacturer_id uuid NOT NULL REFERENCES aeronaves.aircraft_manufacturer(aircraft_manufacturer_id),
...
CREATE TABLE aeronaves.cabin_class (
...
CREATE TABLE aeronaves.aircraft (
    aircraft_id uuid PRIMARY KEY DEFAULT gen_random_uuid(),
    airline_id uuid NOT NULL REFERENCES aerolinea.airline(airline_id),
    aircraft_model_id uuid NOT NULL REFERENCES aeronaves.aircraft_model(aircraft_model_id),
...
CREATE TABLE aeronaves.aircraft_cabin (
    aircraft_cabin_id uuid PRIMARY KEY DEFAULT gen_random_uuid(),
    aircraft_id uuid NOT NULL REFERENCES aeronaves.aircraft(aircraft_id),
...
CREATE TABLE aeronaves.aircraft_seat (
    aircraft_seat_id uuid PRIMARY KEY DEFAULT gen_random_uuid(),
    aircraft_cabin_id uuid NOT NULL REFERENCES aeronaves.aircraft_cabin(aircraft_cabin_id),
...
CREATE TABLE aeronaves.maintenance_provider (
    maintenance_provider_id uuid PRIMARY KEY DEFAULT gen_random_uuid(),
    address_id uuid REFERENCES geografia.address(address_id),
...
CREATE TABLE aeronaves.maintenance_type (
...
CREATE TABLE aeronaves.maintenance_event (
    maintenance_event_id uuid PRIMARY KEY DEFAULT gen_random_uuid(),
    aircraft_id uuid NOT NULL REFERENCES aeronaves.aircraft(aircraft_id),
    maintenance_type_id uuid NOT NULL REFERENCES aeronaves.maintenance_type(maintenance_type_id),
    maintenance_provider_id uuid REFERENCES aeronaves.maintenance_provider(maintenance_provider_id),
