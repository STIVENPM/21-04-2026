...
CREATE TABLE identidad.person_type (
...
CREATE TABLE identidad.document_type (
...
CREATE TABLE identidad.contact_type (
...
CREATE TABLE identidad.person (
    person_id uuid PRIMARY KEY DEFAULT gen_random_uuid(),
    person_type_id uuid NOT NULL REFERENCES identidad.person_type(person_type_id),
    nationality_country_id uuid REFERENCES geografia.country(country_id),
...
CREATE TABLE identidad.person_document (
    person_document_id uuid PRIMARY KEY DEFAULT gen_random_uuid(),
    person_id uuid NOT NULL REFERENCES identidad.person(person_id),
    document_type_id uuid NOT NULL REFERENCES identidad.document_type(document_type_id),
    issuing_country_id uuid REFERENCES geografia.country(country_id),
...
CREATE TABLE identidad.person_contact (
    person_contact_id uuid PRIMARY KEY DEFAULT gen_random_uuid(),
    person_id uuid NOT NULL REFERENCES identidad.person(person_id),
    contact_type_id uuid NOT NULL REFERENCES identidad.contact_type(contact_type_id),
