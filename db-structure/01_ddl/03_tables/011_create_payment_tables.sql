...
CREATE TABLE pagos.payment_status (
...
CREATE TABLE pagos.payment_method (
...
CREATE TABLE pagos.payment (
    payment_id uuid PRIMARY KEY DEFAULT gen_random_uuid(),
    sale_id uuid NOT NULL REFERENCES ventas.sale(sale_id),
    payment_status_id uuid NOT NULL REFERENCES pagos.payment_status(payment_status_id),
    payment_method_id uuid NOT NULL REFERENCES pagos.payment_method(payment_method_id),
...
CREATE TABLE pagos.payment_transaction (
    payment_transaction_id uuid PRIMARY KEY DEFAULT gen_random_uuid(),
    payment_id uuid NOT NULL REFERENCES pagos.payment(payment_id),
