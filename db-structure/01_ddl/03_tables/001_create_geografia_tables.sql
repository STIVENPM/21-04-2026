...
CREATE TABLE geografia.time_zone (
...
CREATE TABLE geografia.continent (
...
CREATE TABLE geografia.country (
    country_id uuid PRIMARY KEY DEFAULT gen_random_uuid(),
    continent_id uuid NOT NULL REFERENCES geografia.continent(continent_id),
...
CREATE TABLE geografia.state_province (
    state_province_id uuid PRIMARY KEY DEFAULT gen_random_uuid(),
    country_id uuid NOT NULL REFERENCES geografia.country(country_id),
...
CREATE TABLE geografia.city (
    city_id uuid PRIMARY KEY DEFAULT gen_random_uuid(),
    state_province_id uuid NOT NULL REFERENCES geografia.state_province(state_province_id),
    time_zone_id uuid NOT NULL REFERENCES geografia.time_zone(time_zone_id),
...
CREATE TABLE geografia.district (
    district_id uuid PRIMARY KEY DEFAULT gen_random_uuid(),
    city_id uuid NOT NULL REFERENCES geografia.city(city_id),
...
CREATE TABLE geografia.address (
    address_id uuid PRIMARY KEY DEFAULT gen_random_uuid(),
    district_id uuid NOT NULL REFERENCES geografia.district(district_id),
...
CREATE TABLE geografia.currency (
