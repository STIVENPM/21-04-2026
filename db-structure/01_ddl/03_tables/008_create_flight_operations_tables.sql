...
CREATE TABLE operaciones.flight_status (
...
CREATE TABLE operaciones.delay_reason_type (
...
CREATE TABLE operaciones.flight (
    ...
    flight_status_id uuid NOT NULL REFERENCES operaciones.flight_status(flight_status_id),
...
CREATE TABLE operaciones.flight_segment (
    flight_segment_id uuid PRIMARY KEY DEFAULT gen_random_uuid(),
    flight_id uuid NOT NULL REFERENCES operaciones.flight(flight_id),
...
CREATE TABLE operaciones.flight_delay (
    ...
    delay_reason_type_id uuid NOT NULL REFERENCES operaciones.delay_reason_type(delay_reason_type_id),
